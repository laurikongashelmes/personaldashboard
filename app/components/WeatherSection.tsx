    ...
    <section>
      ...
      {loading ? (
        <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm animate-pulse">
          ...
          <div className="h-[130px] bg-gray-200 rounded" />
        </div>
      ) : error || !data ? (
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
          {isTomorrow ? (
            <>
              <p data-testid="day-heading" className="text-4xl font-bold text-gray-900 mb-1">Homme</p>
              <p className="text-sm text-gray-500 mb-4">&nbsp;</p>
            </>
          ) : (
            <>
              <p data-testid="day-heading" className="text-4xl font-bold text-gray-900 mb-1">
